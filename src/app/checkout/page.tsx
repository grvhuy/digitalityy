        ...
        <section className="mt-4">
          ...
          <div className="mx-12 border-1 border-transparent rounded-lg bg-gradient-to-b from-blue-500 to-green-500">
            <div className=" flex flex-col justify-center w-full p-4 bg-white dark:bg-gray-900 rounded-md shadow-md">
              <h1 className="font-bold text-blue-600 text-xl mb-4">Address</h1>
          ...
          <div>
            <ScrollArea className="h-72 w-full rounded-md border">
              <div className="flex p-2">
                <img
                  src="https://grvhuy-digitality.s3.ap-southeast-2.amazonaws.com/1711802590884-2382_a3a24090734f99e70c6b44c157180d14f603a624_jabra_elite_85h_titanium_02.png"
                  alt=""
                  width={100}
                  height={100}
                  className="mr-4"
                ...
                <div className="flex flex-col justify-between w-full">
                  ...
                  <div className="flex flex-row justify-between">
                    <h1 className="text-gray-500">Quantity: 2</h1>
                    <span className="font-bold mr-4">$99.00 </span>
                  </div>
                </div>
              </div>
