...
const menuItems = [
  ...
  { name: "Vouchers", path: "/dashboard/vouchers", icon: <MdAssignment /> },
  {
...
const Sidebar = () => {
  ...
  return (
    <aside
      ...
      aria-label="Sidebar"
    >
      <div className="h-full px-3 py-4 overflow-y-auto bg-[#1d203e]">
        <ul className="pt-20 space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Refund requests</span>
            </a>
          </li>
        </ul>
      </div>
