...
export default function SignIn() {
  ...
  return (
    <div className="grid place-items-center">
      <div className="w-[400px] p-5 rounded-lg border-t-4 border-blue-500">
          ...
          <div className="mt-6 items-center justify-center">
            ...
            <div className="flex items-center justify-center space-x-4">
              <Button
                ...
                className="mt-4 rounded-md bg-orange-600 text-white font-bold cursor-pointer px-6 py-2"
              >
                <IoLogoGoogle size={20} className="mx-2" />
              </Button>
              <Button
                onClick={() => signIn("facebook")}
                className="mt-4 rounded-md bg-[#0866ff] text-white font-bold cursor-pointer px-6 py-2"
              >
